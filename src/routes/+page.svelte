...
<script>
  ...
  let score = 0;
  let message =
    'Use WASD to move, SPACE to jump, and E/click to mine. Mouse lock is optional (Play or Enter).';
...
<main>
  <div class="overlay top">
    ...
    <p class="subtitle">WASD move, SPACE jump, mouse look (optional lock), and E/click to mine.</p>
  </div>
